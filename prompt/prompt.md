...
Please add a back and forward arrow button to act as an additional way to transition between pages.
The buttons should be shown in the bottom left, to the left of the slide number indicator and use the same styling as the slide number indicator. 
The slide number indicator should continue to hide after a few seconds, but the arrow keys should never hide and always show.
